import {useDisclosure,Input,Flex,Image,Spacer,Text,Drawer,Box, Container, Icon, Button, DrawerOverlay, DrawerContent, DrawerCloseButton, DrawerHeader, DrawerBody} from "@chakra-ui/react";
...
function Navbar(){
  ...
  return <Container borderBottom={"1px solid silver"} maxW={"full"} zIndex={1} top={0} position={"sticky"}>
