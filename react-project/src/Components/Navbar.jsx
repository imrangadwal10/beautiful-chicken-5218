import {Hide,Flex,Image,Spacer,Text,Box, Container, Icon, Button, DrawerOverlay, DrawerContent, DrawerCloseButton, DrawerHeader, DrawerBody} from "@chakra-ui/react";
...
function Navbar(){
  ...
  return <Container bg={"white"} borderBottom={"1px solid silver"} maxW={{base:"full",md:"100%",lg:"full"}} zIndex={1} top={0} position={"sticky"} >
            <Flex maxW={{base:"full",md:"100%",lg:"full"}} alignItems='center' gap='2'>
  ...
  <Text _hidden={{md:"hidden"}} ref={btnRef} onClick={onOpen} pr={6}>Hello,Log in</Text>
  </Hide>
</>  
