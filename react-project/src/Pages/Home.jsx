...
function Home() {
  return (
    <Box maxW={{ base: "100%", md: "100%", lg: "full" }}>
      <Navbar />
      <Container
        pt={5}
        display={"flex"}
      ...
      >
        {data.map((el) => {
          return (
            <Box
              key={el.img}
              _hover={{ boxShadow: "lg", rounded: "lg" }}
              textAlign={"center"}
              w={150}
              p="13px"
            >
      ...
      <Container ml={10} maxW={{ base: "full", md: "100%", lg: "full" }}>
        <Text mb={10} fontWeight={"semibold"} fontSize={25}>
          Offers Just for You
        </Text>
        <Box display={"flex"} gap={8}>
          <Box
            ...
            w={{ sm: "450px", md: "450px", lg: "300px" }}
            display={"flex"}
          >
            <Image
              mr={5}
              w={{ sm: "80px", md: "100px", lg: "50px" }}
      ...
      <Container ml={10} maxW={"full"}>
        <Text mt={10} fontWeight={"semibold"} fontSize={25}>
          Shop by Categories
        </Text>
      </Container>
      <Container maxW={"full"}>
      ...
      <Container ml={10} maxW={"full"}>
        <Text pb={-10} fontWeight={"semibold"} fontSize={25}>
          New Launches
        </Text>
      ...
      <Container maxW={"95%"} bg={"#EFF1F9"}>
        <Text p={10} pb={-0} fontWeight={"semibold"} fontSize={25}>
      ...
      <Container mt={10} ml={10} maxW={"full"}>
        <Box display={"flex"} gap={10}>
          {ConcernData.map((el) => {
            return (
              <Box key={el.img} w={100} textAlign={"center"}>
                <Image src={el.img} />
                <Text>{el.name}</Text>
              </Box>
            );
      ...
      <Container bg={"#EFF1F9"} maxW={"95%"}>
        <Text p={10} fontWeight={"semibold"} fontSize={25}>
          Why Choose Us?
        </Text>
      </Container>
      <Container
      ...
      >
        {WhyChooseusData.map((el) => {
          return (
            <Box key={el.text1} pb={20} display={"flex"} w={300}>
